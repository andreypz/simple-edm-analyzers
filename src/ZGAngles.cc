...
void ZGAngles::SetAngles(const TLorentzVector& lplus, const TLorentzVector& lminus, const TLorentzVector& gamma)
{
  ...
  //std::cout<<"\t\t z_CM before rotation  x = "<<z_CM.X()<<"  y="<<z_CM.Y()<<"  z="<<z_CM.Z()<<"  t="<<z_CM.T()<<std::endl;
  z_CM.Transform(rotation);
  //std::cout<<"\t\t z_CM after rotation  x = "<<z_CM.X()<<"  y="<<z_CM.Y()<<"  z="<<z_CM.Z()<<"  t="<<z_CM.T()<<std::endl;
  ...
  //std::cout<<"higgs not boostedd  x = "<<h.X()<<"  y="<<h.Y()<<"  z="<<h.Z()<<"  t="<<h.T()<<std::endl;
  //std::cout<<"higgs boostedd   x = "<<h_CM.X()<<"  y="<<h_CM.Y()<<"  z="<<h_CM.Z()<<"  t="<<h_CM.T()<<std::endl;
  //std::cout<<"\t\t z boostedd  x = "<<z_CM.X()<<"  y="<<z_CM.Y()<<"  z="<<z_CM.Z()<<"  t="<<z_CM.T()<<std::endl;

  //std::cout<<"Debug \n"<<"\t\t c1 = "<<_cosTheta<<"\n \t\t c2 = "<<c2<<"\n \t\t c3 = "<<c3<<std::endl;

  if (fabs(_cosTheta)>1 || std::isnan(_cosTheta)){
    std::cout<<"Cosine is greater than 1 or nan,  wha?"<<std::endl;
    exit(0);
  //throw cms::Exception("This is exceptional! ")<<"Cosine is greater than 1 or nan,  wha?"<<std::endl;
  }
  ...
  //Filled!
  //std::cout<<"c1 ="<<_costheta_lplus<<"  c2 ="<<_costheta_lminus<<"  phi ="<<_phi<<"c1 ="<<_cosTheta<<std::endl;

  //std::cout<<"lplus in Z frame: px = "<<lplus_inZFrame.Px()<<"  py = "<<lplus_inZFrame.Py()<<std::endl;
  //std::cout<<"lminus in Z frame: px = "<<lminus_inZFrame.Px()<<"  py = "<<lminus_inZFrame.Py()<<std::endl;
  ...
  // throw cms::Exception("This is exceptional! ")<<"Cosine is greater than 1,  wha?"<<std::endl;
  ...
  //std::cout<<"\t lplus in Z frame: px = "<<lplus_ZFrame.Px()<<"  py = "<<lplus_ZFrame.Py()<<std::endl;
  //std::cout<<"\t lminus in Z frame: px = "<<lminus_ZFrame.Px()<<"  py = "<<lminus_ZFrame.Py()<<std::endl;
